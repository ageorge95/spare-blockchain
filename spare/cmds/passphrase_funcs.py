...
from spare.daemon.client import acquire_connection_to_daemon
from spare.util.errors import KeychainMaxUnlockAttempts
from spare.util.keychain import Keychain, supports_os_passphrase_storage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Spare processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("SPARE_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
