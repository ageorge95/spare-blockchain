...
from spare.cmds.passphrase_funcs import obtain_current_passphrase
...
from spare.util.errors import KeychainException
from spare.util.file_keyring import MAX_LABEL_LENGTH
from spare.util.ints import uint32
from spare.util.keychain import Keychain, KeyData, bytes_to_mnemonic, generate_mnemonic, mnemonic_to_seed
...
def derive_sk_from_hd_path(master_sk: PrivateKey, hd_path_root: str) -> Tuple[PrivateKey, str]:
    ...
    from spare.wallet.derive_keys import _derive_path, _derive_path_unhardened
