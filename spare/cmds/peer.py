...
from spare.cmds.cmds_util import NODE_TYPES
from spare.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Spare service to ip:port", type=str, default="")
@click.option(
