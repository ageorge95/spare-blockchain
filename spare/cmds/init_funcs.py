...
from spare.util.db_version import set_db_version
...
def init(
    ...
    if create_certs is not None:
        ...
        return spare_init(root_path, fix_ssl_permissions=fix_ssl_permissions, testnet=testnet, v1_db=v1_db)
...
def spare_init(
    ...
    *,
    ...
    """
    spare_root = os.environ.get("SPARE_ROOT", None)
    if spare_root is not None:
        print(f"SPARE_ROOT is set to {spare_root}")
