...
from spare.rpc.rpc_server import default_get_connections
from spare.server.outbound_message import NodeType
from spare.simulator.block_tools import BlockTools
from spare.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
from spare.simulator.time_out_assert import adjusted_timeout
...
from spare.wallet.util.wallet_types import AmountWithPuzzlehash
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive SPARE at an address.
