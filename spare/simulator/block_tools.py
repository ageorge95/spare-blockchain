...
from spare.consensus.coinbase import create_farmer_coin, create_pool_coin, create_puzzlehash_for_pk
...
from spare.plotters.chiapos import Params
from spare.plotting.create_plots import PlotKeys, create_plots
...
from spare.simulator.time_out_assert import time_out_assert_custom_interval
from spare.simulator.wallet_tools import WalletTool
...
from spare.types.blockchain_format.program import INFINITE_COST, Program
...
from spare.wallet.puzzles.rom_bootstrap_generator import GENERATOR_MOD
        ...
        try:
            if self.local_keychain:
                ...
                keychain_proxy = await connect_to_keychain_and_validate(
                    self.root_path, self.log, user="testing-1.8.0", service="spare-testing-1.8.0"
                )
            ...
            if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
                raise RuntimeError("Keys not generated. Run `spare keys generate`")
