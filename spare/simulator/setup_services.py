...
from spare.cmds.init_funcs import init
...
from spare.protocols.shared_protocol import Capability, capabilities
from spare.server.start_farmer import create_farmer_service
from spare.server.start_full_node import create_full_node_service
from spare.server.start_harvester import create_harvester_service
from spare.server.start_introducer import create_introducer_service
from spare.server.start_service import Service
from spare.server.start_timelord import create_timelord_service
from spare.server.start_wallet import create_wallet_service
from spare.simulator.block_tools import BlockTools
from spare.simulator.keyring import TempKeyring
from spare.simulator.start_simulator import create_full_node_simulator_service
from spare.timelord.timelord import Timelord
from spare.timelord.timelord_launcher import kill_processes, spawn_process
from spare.types.peer_info import UnresolvedPeerInfo
from spare.util.bech32m import encode_puzzle_hash
from spare.util.config import config_path_for_filename, lock_and_load_config, save_config
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["spare_spam_amount"] = spare_spam_amount
...
async def setup_farmer(
    ...
    service_config["spare_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "spare")
