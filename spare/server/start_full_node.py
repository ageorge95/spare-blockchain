...
from spare.server.start_service import RpcInfo, Service, async_run
from spare.util.spare_logging import initialize_service_logging
...
from spare.util.task_timing import maybe_manage_task_instrumentation
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("SPARE_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_spare_loop_policy", True):
            target_peer_count = None
