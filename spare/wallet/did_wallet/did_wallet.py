...
from spare.wallet.coin_selection import select_coins
from spare.wallet.derivation_record import DerivationRecord
from spare.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from spare.wallet.did_wallet import did_wallet_puzzles
from spare.wallet.did_wallet.did_info import DIDInfo
from spare.wallet.did_wallet.did_wallet_puzzles import uncurry_innerpuz
...
from spare.wallet.singleton import (
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSSpareConnection):
    ...
    async def create_update_spend(self, fee: uint64 = uint64(0), reuse_puzhash: Optional[bool] = None):
        ...
        if spare_tx is not None and spare_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(spare_tx)
