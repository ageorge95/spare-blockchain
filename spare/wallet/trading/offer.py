...
from spare.types.coin_spend import CoinSpend, compute_additions_with_cost
from spare.types.spend_bundle import SpendBundle
from spare.util.bech32m import bech32_decode, bech32_encode, convertbits
from spare.util.errors import Err, ValidationError
from spare.util.ints import uint64
from spare.wallet.outer_puzzles import (
    construct_puzzle,
    create_asset_id,
    get_inner_puzzle,
    get_inner_solution,
...
from spare.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from spare.wallet.util.puzzle_compression import (
    ...
    def _get_offered_coins(self) -> Dict[Optional[bytes32], List[Coin]]:
        ...
        for parent_spend in self._bundle.coin_spends:
            ...
            if puzzle_driver is not None:
                ...
                # It's much easier if the asset is bare SPARE
                asset_id = None
